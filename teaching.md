...
<img src="{{ '/asset/teaching_1.PNG' | relative_url }}" alt="detail" width="200">
<img src="{{ '/asset/teaching_2.JPG' | relative_url }}" alt="detail" width="300">
<img src="{{ '/asset/teaching_3.png' | relative_url }}" alt="detail" width="400">
